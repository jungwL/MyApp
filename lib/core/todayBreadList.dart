...
class TodaySand extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> sandList = [
      ...
      {
        'name': '샌드위치',
        'image': 'images/sand2.jpg',
        'ingredients': '밀가루, 소금, 이스트, 물\n칼로리: 270kcal\n알레르기: 밀',
        'price': '₩6,000',
      },
      {
        'name': '바게트 샌드위치',
        'image': 'images/sand3.jpg',
        'ingredients': '밀가루, 소금, 이스트, 물\n칼로리: 270kcal\n알레르기: 밀',
        'price': '₩5,000',
      },
      {
        'name': '햄치즈 샌드위치',
        'image': 'images/sand4.jpg',
        'ingredients': '밀가루, 소금, 이스트, 물\n칼로리: 270kcal\n알레르기: 밀',
        'price': '₩4,000',
      },
    ];
    ...
    final List<Map<String, String>> cakeList = [
      {
        ...
        'ingredients': '초콜릿, 밀가루, 크림\n칼로리: 320kcal\n알레르기: 밀',
        'price': '₩15,000',
      },
      {
        'name': '딸기 케이크',
        'image': '/images/cake2.jpg',
        'ingredients': '딸기, 밀가루, 크림\n칼로리: 320kcal\n알레르기: 밀',
        'price': '₩17,000',
      },
      {
        'name': '치즈 케이크',
        'image': '/images/cake3.jpg',
        'ingredients': '치즈, 밀가루, 크림\n칼로리: 320kcal\n알레르기: 밀',
        'price': '₩15,000',
      },
      {
        'name': '오레오 케이크',
        'image': '/images/cake4.jpg',
        'ingredients': '오레오, 밀가루, 크림\n칼로리: 320kcal\n알레르기: 밀',
        'price': '₩12,000',
      },
    ];
